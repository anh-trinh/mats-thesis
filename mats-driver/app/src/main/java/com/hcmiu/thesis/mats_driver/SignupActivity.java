...
public class SignupActivity extends AppCompatActivity {
    ...
    @InjectView(R.id.input_cartype) TextView _car_type;
    ...
    public void signup() {
        ...
        String car_type = _car_type.getText().toString();

        // TODO: Implement your own signup logic here.
        new MyTask(name,email,phone,password,car_type).execute();
    }
    ...
    private class MyTask extends AsyncTask<Object, Object, Boolean> {
        ...
        public MyTask(String name, String email, String phone, String password, String car_type){
            this.name = name;
            this.email = email;
            this.phone = phone;
        ...
        protected Boolean doInBackground(Object... params) {
            boolean key = false;
            try {
                DriverDataAccess dri = new DriverDataAccess();
                final ResultSet result = dri.select();
                while (result.next()) {
                ...
                if (message=="Successfully"){
                    ...
                    String id_add = ""+id;
                    dri.insert(id_add,email,phone,getMD5(password),name,car_type);
